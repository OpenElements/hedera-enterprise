...
public record ContractCallResult(@NonNull TransactionId transactionId, @NonNull Status status, @NonNull byte[] transactionHash, @NonNull Instant consensusTimestamp, @NonNull Hbar transactionFee, @NonNull ContractFunctionResult contractFunctionResult) implements TransactionRecord {
