...
public class FileClientImpl implements FileClient {
    ...
    @Override
    public FileId createFile(@NonNull final byte[] contents, @NonNull final Instant expirationTime) throws HieroException {
        return createFileImpl(contents, expirationTime);
    }

    private FileId createFileImpl(@NonNull final byte[] contents, @Nullable final Instant expirationTime) throws HieroException {
    ...
    @Override
    public void updateExpirationTime(@NonNull final FileId fileId, @NonNull final Instant expirationTime) throws HieroException {
        Objects.requireNonNull(fileId, "fileId must not be null");
